...
pub const STB_VORBIS_INCLUDE_STB_VORBIS_H = "";
pub const _STDIO_H_ = "";
...
// /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/assert.h:58:9

// /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/assert.h:71:9
...
pub inline fn FASTDEF(x: anytype) @TypeOf(float_conv ++ x) {
    _ = &x;
    return float_conv ++ x;
}
pub inline fn MAGIC(SHIFT: anytype) @TypeOf((@as(f32, 1.5) * (@as(c_int, 1) << (@as(c_int, 23) - SHIFT))) + @import("std").zig.c_translation.MacroArithmetic.div(@as(f32, 0.5), @as(c_int, 1) << SHIFT)) {
    _ = &SHIFT;
    return (@as(f32, 1.5) * (@as(c_int, 1) << (@as(c_int, 23) - SHIFT))) + @import("std").zig.c_translation.MacroArithmetic.div(@as(f32, 0.5), @as(c_int, 1) << SHIFT);
}
pub inline fn ADDEND(SHIFT: anytype) @TypeOf(((@as(c_int, 150) - SHIFT) << @as(c_int, 23)) + (@as(c_int, 1) << @as(c_int, 22))) {
    _ = &SHIFT;
    return ((@as(c_int, 150) - SHIFT) << @as(c_int, 23)) + (@as(c_int, 1) << @as(c_int, 22));
}
// vorgbis.h:5157:12
// vorgbis.h:5158:12
pub const STB_BUFFER_SIZE = @as(c_int, 32);
...
pub const STBVorbisError = enum_STBVorbisError;
